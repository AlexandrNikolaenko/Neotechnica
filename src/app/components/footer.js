            ...
            <div className={'wrapper z-20 relative'}>
                <div className="flex justify-between py-5">
                    <div className={'flex flex-col gap-y-2.5'}>
                        <FooterTitleLink text={'О компании'} isLightColor={true} />
                    ...
                    <div className={'flex flex-col gap-y-2.5 max-w-[232px]'}>
                        <FooterTitleLink text={'Продукция и услуги'} isLightColor={false} />
                    ...
                    <div className={'flex flex-col gap-y-2.5 max-w-[232px]'}>
                        <FooterTitleLink text={'Контакты'} isLightColor={false} />
